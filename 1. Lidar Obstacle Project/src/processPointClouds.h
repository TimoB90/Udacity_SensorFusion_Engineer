...
template <typename PointT> class ProcessPointClouds {
  ...
  public:
    ...
    void proximity(const std::vector<std::vector<float>> &points, std::vector<int> &cluster, std::vector<bool> &processed, const int index, const float tolerance, KdTree *tree);
